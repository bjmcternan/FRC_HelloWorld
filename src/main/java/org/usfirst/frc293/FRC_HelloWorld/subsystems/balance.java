...
public class balance extends Subsystem {
    ...
    private AnalogAccelerometer analogGSensor;
    ...
    public balance() {
        ...
        talon = new WPI_TalonSRX(16);
        
        
        
        analogGSensor = new AnalogAccelerometer(0);
        addChild("analogGSensor",analogGSensor);
        analogGSensor.setSensitivity(0.0);
        analogGSensor.setZero(2.5);
    ...
    public void setMotorSpeed(double gSensorY) {
    ...
    private void updateBalanceSensor() {
    ...
    public double getBalanceSensor() {
        return testValuesXAxis;
    }
}
